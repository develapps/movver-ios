...
Pod::Spec.new do |s|
  s.name             = 'movver-ios'
  s.version          = '0.1.0'
  s.summary          = 'A short description of movver-ios.'
...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/<GITHUB_USERNAME>/movver-ios'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'Pablo Romeu' => 'pablo.romeu@develapps.com' }
  s.source           = { :git => 'https://github.com/<GITHUB_USERNAME>/movver-ios.git', :tag => s.version.to_s }
